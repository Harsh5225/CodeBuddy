                          ...
                          <div className="flex flex-wrap gap-1">
                            {Array.isArray(problem.tags) ? (
                              problem.tags.map((tag, i) => (
                                <span
                                  key={i}
                                  className="px-2 py-1 bg-gradient-to-r from-purple-500/20 to-blue-500/20 text-purple-400 border border-purple-500/30 rounded-full text-xs font-semibold"
                                >
                                  {tag}
                                </span>
                              ))
                            ) : (
                              <span className="px-2 py-1 bg-gradient-to-r from-purple-500/20 to-blue-500/20 text-purple-400 border border-purple-500/30 rounded-full text-xs font-semibold">
                                {problem.tags}
                              </span>
                            )}
                          </div>

        ...
        <div className="relative z-10">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between items-center h-14">
                ...
                <div className="hidden md:flex items-center space-x-3">
                  ...
                  <Link
                    to="/signup"
                    className="px-5 py-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white rounded-lg font-medium transition-all duration-200 hover:scale-105 shadow-lg shadow-purple-500/25 text-sm"
                  >
                    Sign Up
                  </Link>
                </div>
                ...
                <div className="md:hidden py-4 border-t border-gray-700/50">
                  <div className="flex flex-col space-y-3">
                    ...
                    <div className="flex flex-col space-y-2 pt-3 border-t border-gray-700/50">
                      ...
                      <Link
                        to="/signup"
                        className="px-5 py-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white rounded-lg font-medium transition-all duration-200 text-center text-sm"
                      >
                        Sign Up
                      </Link>
                    </div>
          ...
          <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 relative">
            <div className="max-w-6xl mx-auto text-center">
              ...
              >
                <div className="mb-10">
                  <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20 rounded-full mb-6 backdrop-blur-sm animate-pulse">
                    <Sparkles className="w-4 h-4 mr-2 text-purple-400 animate-pulse" />
                    <span className="text-purple-300 font-medium text-sm">AI-Powered Coding Platform</span>
                    <div className="ml-2 px-2 py-1 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full text-xs font-bold text-white">
                      NEW
                    </div>
                  </div>

                  <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
                    <span className="bg-gradient-to-r from-purple-400 via-blue-400 to-purple-400 bg-clip-text text-transparent animate-gradient-shift">
                      Code
                    </span>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                  <Link
                    to="/signup"
                    className="group inline-flex items-center px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-xl shadow-purple-500/25 hover:shadow-purple-500/40"
                  >
                  ...
                  <Link
                    to="/demo"
                    className="group inline-flex items-center px-8 py-3 bg-gray-800/50 hover:bg-gray-700/50 text-white border border-gray-600/50 hover:border-purple-500/50 rounded-lg font-semibold transition-all duration-300 hover:scale-105 backdrop-blur-sm"
                  >
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="animate-slide-in-left" style={{ opacity: 0 }}>
                  <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20 rounded-full mb-6">
                    <Rocket className="w-4 h-4 mr-2 text-purple-400" />
                    <span className="text-purple-300 font-medium text-sm">Introduction</span>
                  </div>
                  ...
                  <div className="relative">
                    <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/30 rounded-2xl border border-gray-600/30 backdrop-blur-sm p-6 shadow-2xl">
                      ...
                      <div className="font-mono text-sm space-y-2">
                        <div className="text-green-400">$ codebuddy start</div>
                        <div className="text-gray-300">🚀 Initializing AI assistant...</div>
                        <div className="text-blue-400">✓ Loading problem set</div>
                        <div className="text-purple-400">✓ Analyzing your progress</div>
                        <div className="text-yellow-400">✓ Preparing personalized hints</div>
                        <div className="text-green-400">Ready to code! 💻</div>
                        <div className="text-gray-500 animate-pulse">|</div>
                      </div>
                    </div>
                    <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-full blur-xl animate-pulse"></div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20 rounded-full mb-6">
                  ...
                  <span className="text-purple-300 font-medium text-sm">Features</span>
                </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20 rounded-full mb-6">
                  ...
                  <span className="text-purple-300 font-medium text-sm">Application Features</span>
                </div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  <div>
                    <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20 rounded-full mb-6">
                      ...
                      <span className="text-purple-300 font-medium text-sm">AI-Powered</span>
                    </div>
          ...
          <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/20 via-blue-900/20 to-purple-900/20 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  to="/demo"
                  className="inline-flex items-center px-8 py-3 bg-gray-800/50 hover:bg-gray-700/50 text-white border border-gray-600/50 hover:border-purple-500/50 rounded-lg font-semibold transition-all duration-300 hover:scale-105 backdrop-blur-sm"
                >
                  Try Demo
                </Link>
              </div>
  ...
  <div className="bg-gray-800/50 rounded-xl border border-gray-600/30 backdrop-blur-sm overflow-hidden shadow-xl">
    ...
    <div className="p-6 space-y-4 max-h-80 overflow-y-auto">
      <div className="flex items-start space-x-3">
        <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg shadow-purple-500/25">
      ...
      <div className="flex items-start space-x-3 justify-end">
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg p-3 max-w-xs shadow-lg shadow-purple-500/25">
...
const SocialLink = ({ href, icon }) => (
  <a
    href={href}
    className="w-8 h-8 bg-gray-800/50 hover:bg-gradient-to-r hover:from-purple-600 hover:to-blue-600 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300 hover:scale-110"
  >
    {icon}
  </a>
)
...
const FooterLink = ({ href, text }) => (
  <Link to={href} className="text-gray-400 hover:text-purple-400 transition-colors duration-200 text-sm">
    {text}
  </Link>
)
...
const CreativeAnimatedBackground = () => (
  <div className="fixed inset-0 z-0 overflow-hidden">
    <div className="absolute inset-0 bg-gradient-to-br from-purple-900/10 via-blue-900/10 to-purple-900/10"></div>
    ...
    <div className="absolute top-16 left-8 opacity-30 animate-float">
      <div className="bg-gray-800/40 rounded-xl p-4 border border-gray-700/40 backdrop-blur-sm shadow-xl">
        <div className="text-xs font-mono">
          <div className="text-purple-400">function binarySearch(arr, target) {"{"}</div>
          <div className="text-blue-400 ml-2">let left = 0, right = arr.length - 1;</div>
          <div className="text-green-400 ml-2">while (left &lt;= right) {"{"}</div>
    ...
    <div className="absolute top-32 right-16 opacity-30 animate-float-delayed">
      <div className="bg-gray-800/40 rounded-xl p-4 border border-gray-700/40 backdrop-blur-sm shadow-xl">
        <div className="text-xs font-mono">
          ...
          <div className="text-green-400 ml-0">def inorder_traversal(root):</div>
          <div className="text-blue-400 ml-4">if not root: return []</div>
          <div className="text-purple-400 ml-4">return (inorder_traversal(root.left) +</div>
          <div className="text-purple-400 ml-12">[root.val] +</div>
          <div className="text-purple-400 ml-12">inorder_traversal(root.right))</div>
        </div>
      </div>
    </div>
    ...
    <div className="absolute bottom-24 left-16 opacity-30 animate-float">
      <div className="bg-gray-800/40 rounded-xl p-4 border border-gray-700/40 backdrop-blur-sm shadow-xl">
        <div className="text-xs font-mono">
          ...
          <div className="text-purple-400 ml-2">if (arr.length &lt;= 1) return arr;</div>
          <div className="text-blue-400 ml-2">const pivot = arr[0];</div>
          <div className="text-green-400 ml-2">const left = arr.slice(1).filter(x =&gt; x &lt; pivot);</div>
    ...
    <div className="absolute top-1/2 right-8 opacity-30 animate-float-delayed">
      <div className="bg-gray-800/40 rounded-xl p-4 border border-gray-700/40 backdrop-blur-sm shadow-xl">
        <div className="text-xs font-mono">
          ...
          <div className="text-green-400 ml-4">dp[1] = 1</div>
          <div className="text-blue-400 ml-4">for i in range(2, n + 1):</div>
          <div className="text-purple-400 ml-8">dp[i] = dp[i-1] + dp[i-2]</div>
    ...
    <div className="absolute bottom-1/3 right-1/4 opacity-30 animate-float">
      <div className="bg-gray-800/40 rounded-xl p-4 border border-gray-700/40 backdrop-blur-sm shadow-xl">
        <div className="text-xs font-mono">
          ...
          <div className="text-green-400 ml-2">const mid = Math.floor(arr.length / 2);</div>
    ...
    <div className="absolute top-1/3 right-12 opacity-20 animate-float">
      <div className="w-24 h-24 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-full blur-xl"></div>
    </div>
    ...
    <div className="absolute top-2/3 left-12 opacity-20 animate-float">
      <div className="w-16 h-16 bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-full blur-xl"></div>
    </div>
  </div>
)
